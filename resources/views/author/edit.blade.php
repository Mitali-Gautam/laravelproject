    ...
    <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <form class="form-sample" name="author_info_update" method="post" action="{{ route('authors.update',$author->id) }}">
                @csrf
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="author Name" name="name" value="{{ $author->name}}"/>
                      </div>
                      @error('name')
