    ...
    <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <form class="form-sample" name="publisher_info_update" method="post" action="{{ route('publishers.update',$publisher->id) }}">
                @csrf
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="Publisher Name" name="name" value="{{ $publisher->name}}"/>
                      </div>
                      @error('name')
